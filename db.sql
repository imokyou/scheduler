...
CREATE TABLE IF NOT EXISTS `schedule` (
    ...
    `targets` TEXT COMMENT COMMENT'需要完成的事项',
    `created_at` DATETIME COMMENT'创建时间',
    `updated_at` DATETIME COMMENT '更新时间',
    PRIMARY KEY (`id`)
) ENGING=InnoDB DEFAULT CHARSET=utf8 COMMENT '日程计划表';
...
CREATE TABLE IF NOT EXISTS `schedule_config` (
    ...
    `updated_at` DATETIME COMMENT '更新时间',
    PRIMARY KEY (`id`)
) ENGING=InnoDB DEFAULT CHARSET=utf8 COMMENT '日程计划配置表';
...
CREATE TABLE IF NOT EXISTS `code_memo` (
    ...
    `content` TEXT COMMENT COMMENT'代码内容',
    `created_at` DATETIME COMMENT'创建时间',
    `updated_at` DATETIME COMMENT '更新时间',
    PRIMARY KEY (`id`)
) ENGING=InnoDB DEFAULT CHARSET=utf8 COMMENT '代码备忘录表';
